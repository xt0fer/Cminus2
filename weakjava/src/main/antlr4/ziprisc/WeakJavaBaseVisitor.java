...
/**
 * This class provides an empty implementation of {@link WeakJavaVisitor},
 ...
 */
public class WeakJavaBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements WeakJavaVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
